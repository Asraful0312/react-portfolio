...
export interface ApiAdminDetailAdminDetail extends Schema.CollectionType {
  ...
  attributes: {
    ...
    dsec: Attribute.Text & Attribute.Required;
    links: Attribute.Relation<
      'api::admin-detail.admin-detail',
      'manyToMany',
      'api::link.link'
    >;
    exps: Attribute.Relation<
      'api::admin-detail.admin-detail',
      'manyToMany',
      'api::exp.exp'
    >;
    edus: Attribute.Relation<
      'api::admin-detail.admin-detail',
      'manyToMany',
      'api::edu.edu'
    >;
...
export interface ApiEduEdu extends Schema.CollectionType {
  collectionName: 'edus';
  info: {
    singularName: 'edu';
    pluralName: 'edus';
  ...
  attributes: {
    ...
    name: Attribute.String;
    admin_details: Attribute.Relation<
      'api::edu.edu',
      'manyToMany',
      'api::admin-detail.admin-detail'
    >;
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::edu.edu', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::edu.edu', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiLangugeLanguge extends Schema.CollectionType {
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    demo: Attribute.String & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::admin-detail.admin-detail': ApiAdminDetailAdminDetail;
      'api::contact.contact': ApiContactContact;
      'api::edu.edu': ApiEduEdu;
      'api::exp.exp': ApiExpExp;
      'api::languge.languge': ApiLangugeLanguge;
